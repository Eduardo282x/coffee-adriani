...
import { GroupInvoices, IInvoiceFilter, IInvoiceForm, InvoiceApi } from "@/interfaces/invoice.interface"
...
export const Invoices = () => {
    ...
    const getInvoicesFilterApi = async () => {
        setLoading(true);
        const filterDate: IInvoiceFilter = {
    ...
    const handleChangeBlock = (option: string) => {
        ...
        console.log(filterClientsByBlock);
                                    ...
                                    {invoice && invoice.invoices.map((inv: InvoiceApi, index: number) => (
                                        <TableRow key={index}>
                                            <TableCell colSpan={clientColumns.length} className="p-0">
                                                <Expansible invoice={inv} columns={invoiceColumns}></Expansible>
                                            </TableCell>
                                        </TableRow>
                                    ))}
                                </TableBody>
